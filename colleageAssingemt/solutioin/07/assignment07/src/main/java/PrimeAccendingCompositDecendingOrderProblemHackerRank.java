...
public class PrimeAccendingCompositDecendingOrderProblemHackerRank {
    public static void main(String[] args) {

        int[] data = {5, 4, 9, 8, 2, 6};
        int result[] = performOperation(6, data);
        System.out.println(Arrays.toString(result));
    }

    private static int[] performOperation(int N, int[] data) {
